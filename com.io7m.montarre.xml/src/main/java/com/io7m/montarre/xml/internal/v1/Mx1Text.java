...
public final class Mx1Text
  implements BTElementHandlerType<Object, MText>
{
  private final StringBuilder text;
  private MLanguageCode language;
  ...
  {
    this.language = new MLanguageCode(attributes.getValue("Language"));
  }

  @Override
  public MText onElementFinished(
    final BTElementParsingContextType context)
  {
    return new MText(
      this.language,

...
import com.io7m.montarre.xml.internal.v1.Mx1Package;
...
public final class MPackageDeclarationParser implements
  MPackageDeclarationParserType
{
  ...
  public MPackageDeclarationParser(
  ...
  @Override
  public MPackageDeclaration execute()
    throws ParsingException
  {
    try {
      final MPackageDeclaration mpack =
      ...
      final var statuses =
        e.errors()
          .stream()
          .map(MPackageDeclarationParser::mapParseError)
          .toList();
